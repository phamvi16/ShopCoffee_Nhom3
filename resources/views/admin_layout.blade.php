...
<head>
    ...
    <link href="{{asset('Admins/css/now-ui-dashboard.css?v=1.0.1')}}" rel="stylesheet" />
...
<script src="{{asset('Admins/js/plugins/bootstrap-notify.js')}}"></script>
<!-- Control Center for Now Ui Dashboard: parallax effects, scripts for the example pages etc -->
<script src="{{asset('Admins/js/now-ui-dashboard.js?v=1.0.1')}}"></script>
<!-- Now Ui Dashboard DEMO methods, don't include it in your project! -->
<script src="{{asset('Admins/demo/demo.js')}}"></script>
<script>
