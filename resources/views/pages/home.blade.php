 ...
 <section class="tm-welcome-section">
  ...
  <div class="tm-main-section light-gray-bg">
      <div class="container" id="main">
        <section class="tm-section row">
          ...
          <div class="col-lg-3 col-md-3 col-sm-4 tm-welcome-img-container">
            <div class="inline-block shadow-img">
              <img src="{{asset('Page/img/1.jpg')}}" alt="Image" class="img-circle img-thumbnail">
            </div>
          </div>
        </section>
        <section class="tm-section tm-section-margin-bottom-0 row">
          <div class="col-lg-12 tm-section-header-container">
            <h2 class="tm-section-header gold-text tm-handwriting-font"><img src="{{asset('Page/img/logo.png')}}" alt="Logo" class="tm-site-logo"> Popular Items</h2>
            <div class="tm-hr-container"><hr class="tm-hr"></div>
          </div>
          <div class="col-lg-12 tm-popular-items-container">
            <div class="tm-popular-item">
              <img src="{{asset('Page/img/popular-1.jpg')}}" alt="Popular" class="tm-popular-item-img">
            ...
            <div class="tm-popular-item">
              <img src="{{asset('Page/img/popular-2.jpg')}}" alt="Popular" class="tm-popular-item-img">
              <div class="tm-popular-item-description">
            ...
            <div class="tm-popular-item">
              <img src="{{asset('Page/img/popular-3.jpg')}}" alt="Popular" class="tm-popular-item-img">
              <div class="tm-popular-item-description">
        ...
        <section class="tm-section row">
          <div class="col-lg-12 tm-section-header-container">
            <h2 class="tm-section-header gold-text tm-handwriting-font"><img src="{{asset('Page/img/logo.png')}}" alt="Logo" class="tm-site-logo"> Today's Special</h2>
            <div class="tm-hr-container"><hr class="tm-hr"></div>
          </div>
          <div class="col-lg-12 tm-special-container margin-top-60">
            <div class="tm-special-container-left"> <!-- left -->
              <div class="tm-special-item">
                <div class="tm-special-img-container">
                  <img src="{{asset('Page/img/special-1.jpg')}}" alt="Special" class="tm-special-img img-responsive">
                  <a href="#">
            ...
            <div class="tm-special-container-right"> <!-- right -->
              <div>
                <div class="tm-special-item">
                  <div class="tm-special-img-container">
                    <img src="{{asset('Page/img/special-2.jpg')}}" alt="Special" class="img-responsive">
                    <a href="#">
                      <div class="tm-special-description">
              ...
              <div class="tm-special-container-lower">
                <div class="tm-special-item">
                  <div class="tm-special-img-container">
                    <img src="{{asset('Page/img/special-3.jpg')}}" alt="Special" class="img-responsive">
                    <a href="#">
                      <div class="tm-special-description">
                ...
                <div class="tm-special-item">
                  <div class="tm-special-img-container">
                    <img src="{{asset('Page/img/special-4.jpg')}}" alt="Special" class="img-responsive">
                    <a href="#">
                      <div class="tm-special-description">
                        <p>Quisque rutrum.</p>
                      </div>
        ...
        <section class="tm-section">
          <div class="row">
            <div class="col-lg-12 tm-section-header-container">
              <h2 class="tm-section-header gold-text tm-handwriting-font"><img src="{{asset('Page/img/logo.png')}}" alt="Logo" class="tm-site-logo"> Daily Menu</h2>
              <div class="tm-hr-container"><hr class="tm-hr"></div>
            </div>
          </div>
          <div class="row">
            <div class="tm-daily-menu-container margin-top-60">
              <div class="col-lg-4 col-md-4">
                <img src="{{asset('Page/img/menu-board.png')}}" alt="Menu board" class="tm-daily-menu-img">
              </div>
